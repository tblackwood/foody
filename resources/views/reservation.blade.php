...
@section('title', 'Foody - Italian Restaurant')
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 p-b-30">
                    ...
                    <form class="wrap-form-reservation size22 m-l-r-auto"method="POST" action="{{ route('reservation.reserv') }}">
                        @csrf
                        <div class="row">
                            <div class="col-md-4">
                                <!-- Date -->
                                ...
                                <div class="wrap-inputdate pos-relative txt10 size12 bo2 bo-rad-10 m-t-3 m-b-23">
                                    <input class="my-calendar bo-rad-10 sizefull txt10 p-l-20" type="text" name="date" required="required">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="wrap-inputpeople size12 bo2 bo-rad-10 m-t-3 m-b-23">
                                    <!-- Select2 -->
                                    <select class="selection-1" name="people" required="required">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                ...
                                <div class="wrap-inputname size12 bo2 bo-rad-10 m-t-3 m-b-23">
                                    <input class="bo-rad-10 sizefull txt10 p-l-20" type="text" name="name" placeholder="Name" required="required">
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="wrap-inputemail size12 bo2 bo-rad-10 m-t-3 m-b-23">
                                    <input class="bo-rad-10 sizefull txt10 p-l-20" type="text" name="email" placeholder="Email" required="required">
                                </div>
                            </div>
