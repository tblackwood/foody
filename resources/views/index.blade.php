        ...
        <div class="wrap-slick1">
            <div class="slick1">
                @foreach($sliders as $slider)
                    <div class="item-slick1 item1-slick1" style="background-image: url({{ asset($slider->image) }});">
                        ...
                        @if($k == 0 || $k==1)
                            <div class="col-sm-6">
                                ...
                                <div class="item-ourmenu bo-rad-10 hov-img-zoom pos-relative m-t-30">
                                    <img src="{{ asset($item->image) }}" alt="IMG-MENU">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 p-b-30">
                    ...
                    <form class="wrap-form-booking" method="POST" action="{{ route('reservation.reserv') }}">
                        @csrf
                        <div class="row">
                            <div class="col-md-6">
                                <!-- Date -->
