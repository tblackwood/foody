    ...
    <section class="section-contact bg1-pattern p-t-90 p-b-113">
        ...
        <div class="container">
            <div class="map bo8 bo-rad-10 of-hidden">
                <div class="contact-map size37" id="google_map" data-map-x="40.704644" data-map-y="-74.011987" data-pin="{{ asset('images/icons/icon-position-map.png') }}" data-scrollwhell="0" data-draggable="1"></div>
            </div>
        </div>
        ...
        <div class="container">
            ...
            <form class="wrap-form-reservation size22 m-l-r-auto" method="POST" action="{{ route('contact.send') }}">
                @csrf
                <div class="row">
                    <div class="col-md-4">
                        <!-- Name -->
